...
//
  // UseEffect para controlar el tiempo de visualización del SplashScreen
  //useEffect(() => {
  //  const timer = setTimeout(() => setShowSplash(false), 3000); // Mostrar SplashScreen por 3 segundos
