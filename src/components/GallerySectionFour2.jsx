...
const GallerySectionFour2 = () => {
  ...
  return (
    <section className="h-screen w-screen flex flex-col lg:flex-row justify-between px-2 pt-2 lg:pt-0 py-0 lg:py-2 gap-2 lg:gap-2 overflow-hidden items-start">
