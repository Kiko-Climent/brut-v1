...
const GallerySectionOne = () => {
  ...
  return (
    <section className="h-screen flex justify-between px-2 pt-5 lg:pt-6 relative overflow-hidden">

      <div className="w-2/5 lg:w-1/4 h-full flex flex-col">
        <div className="">
      ...
      <div className="w-7/12 lg:w-1/2 h-1/2 lg:h-full relative group">
...
// LAYOUT FOR SM, h-full on main pic for small devices??
// return (
//   <section className="h-screen w-full flex-col px-2 pt-5 lg:pt-6 relative overflow-hidden">

//     <div className="w-full lg:w-1/4 flex items-end gap-2">
