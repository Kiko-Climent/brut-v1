...
//   return (
//     <section className="h-screen flex justify-between px-2 gap-2 overflow-hidden items-start">
...
// };
return (
  <section className="h-full w-full flex-col px-2 gap-2 overflow-hidden">
