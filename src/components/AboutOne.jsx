...
const AboutOne = () => {
  return (
    <section className="h-screen bg-[#0c130c] overflow-hidden w-screen">
      <div className='justify-between items-center flex pl-2 w-full gap-2'>
        <div className="text-white text-justify w-1/3">
          ...
          <p className="text-xs">
            ...
            captures a unique blend of form an2 function, challenging conventional design norms and encouraging a deeper appreciation of structure.
          ...
          <h1 className='border-b border-white leading-tight pt-1'>photographers</h1>
