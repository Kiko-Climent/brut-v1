...
// }
  return (
    <section className="h-screen bg-[#0c130c] overflow-hidden w-screen text-white pb-2 pt-5 lg:pt-6">
      <div className='h-full flex-col text-justify'>
        <div className='px-2 flex w-full gap-2'>
          ...
          <div className='w-5/12'>
            ...
            <p className="text-xs">Alexandr Neplokhov<br/>Goran Petkovic<br/>Ivan Aleksic<br/>Joel Filipe<br/>Katejan Powolny<br/>Kotryna Juskaite<br/>Mike Hindle<br/>Pavel Neznanov.</p>
            <p className='text-sm leading-none mt-4'>Brutalist<br/>Brutalista<br/>ブルータリスト<br/>Бруталист<br/>Μπρουταλιστής<br/>브루탈리스트</p>
          </div>
